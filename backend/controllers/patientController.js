...
exports.updateEmail = catchAsync(async (req, res, next) => {
  // Create error if the Patient Posts password data
  ...
  // Retrieve the current patient's ID from the request object
  ...
  if (patient.email === email) {
    return next(
      new AppError("New email must be different from the current email", 400)
    );
  }
  ...
  // Find the Patient by ID and update the email
